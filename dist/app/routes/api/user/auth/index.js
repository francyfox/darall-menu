...
var user_auth_1 = require("../../../../module/user/user.auth");
exports.default = (function (express) { return ({
    post: function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, _b, accessToken, refreshToken, e_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _a = request.body, email = _a.email, password = _a.password;
                    return [4 /*yield*/, (0, user_auth_1.userAuth)(response, email, password)];
                case 1:
